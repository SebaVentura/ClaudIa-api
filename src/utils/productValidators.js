...
export function normalizeProduct(raw) {
  ...
  return {
    ...
    downloadLink: product.downloadLink ?? product.deliveryUrl ?? product.downloadUrl ?? '',
    deliveryUrl: product.deliveryUrl ?? product.downloadLink ?? product.downloadUrl ?? '',
    downloadUrl: product.downloadUrl ?? product.downloadLink ?? product.deliveryUrl ?? '',
